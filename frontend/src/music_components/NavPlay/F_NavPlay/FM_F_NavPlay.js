...
const FM_F_NavPlay = () => {
    const { isPlaying, continuousPlay, playButtonDisabled, handleStop, displayRest, delay, stopAfterMeasures, handlePlayCont, handlePlayScale, handlePlayKey } = useMusicControl('F');
