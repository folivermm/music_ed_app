...
import DM_IntMusicScore from '../../MusicScore/D_IntMusicScore/DM_IntMusicScore';
import DM_MusicPlay from '../../MusicPlay/D_MusicPlay/DM_MusicPlay';
import './DM_D_NavPlay.css';
        ...
        <div className="nav-play-container">
            <div className="nav-play">
                <div className="controls-container">
                    ...
                    <DM_MusicPlay tempo={tempo} shouldStart={isPlaying || continuousPlay} shouldRefreshPage={shouldRefreshPage} continuousPlay={continuousPlay} />                </div>
                <div className="music-container">
                    <DM_IntMusicScore displayRest={displayRest} tempo={tempo} shouldStart={isPlaying || continuousPlay} delay={delay} />                </div>
            </div>
        </div>
    );
};

export default DM_D_NavPlay;
