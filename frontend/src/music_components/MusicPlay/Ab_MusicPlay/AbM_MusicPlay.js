...
const AbM_MusicPlay = ({ tempo, shouldStart, shouldRefreshPage, continuousPlay }) => {
    ...
    const handleMusicStart = async () => {
        ...
        const notes = [
            { pitch: 'Ab3', timing: '0:0' },
            { pitch: 'Bb3', timing: '0:1' },
            { pitch: 'C4', timing: '0:2' },
            { pitch: 'Db4', timing: '0:3' },
            { pitch: 'Eb4', timing: '0:4' },
            { pitch: 'F4', timing: '0:5' },
            { pitch: 'G4', timing: '0:6' },
            { pitch: 'Ab4', timing: '0:7' },
            { pitch: 'Bb4', timing: '0:8' },
            { pitch: 'Ab4', timing: '0:9' },
            { pitch: 'G4', timing: '0:10' },
            { pitch: 'F4', timing: '0:11' },
            { pitch: 'Eb4', timing: '0:12' },
            { pitch: 'Db4', timing: '0:13' },
            { pitch: 'C4', timing: '0:14' },
            { pitch: 'Bb3', timing: '0:15' },
        ];
