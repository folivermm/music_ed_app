...
const BM_MusicPlay = ({ tempo, shouldStart, shouldRefreshPage, continuousPlay }) => {
    ...
    const handleMusicStart = async () => {
        ...
        const notes = [
            { pitch: 'B3', timing: '0:0' },
            { pitch: 'C#4', timing: '0:1' },
            { pitch: 'D#4', timing: '0:2' },
            { pitch: 'E4', timing: '0:3' },
            { pitch: 'F#4', timing: '0:4' },
            { pitch: 'G#4', timing: '0:5' },
            { pitch: 'A#4', timing: '0:6' },
            { pitch: 'B4', timing: '0:7' },
            { pitch: 'C#5', timing: '0:8' },
            { pitch: 'B4', timing: '0:9' },
            { pitch: 'A#4', timing: '0:10' },
            { pitch: 'G#4', timing: '0:11' },
            { pitch: 'F#4', timing: '0:12' },
            { pitch: 'E4', timing: '0:13' },
            { pitch: 'D#4', timing: '0:14' },
            { pitch: 'C#4', timing: '0:15' },
        ];
