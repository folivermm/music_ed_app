...
const DM_MusicPlay = ({ tempo, shouldStart, shouldRefreshPage, continuousPlay }) => {
    ...
    const handleMusicStart = async () => {
        ...
        const notes = [
            ...
            { pitch: 'A4', timing: '0:4' },
            { pitch: 'B5', timing: '0:5' },
            { pitch: 'C#5', timing: '0:6' },
            { pitch: 'D5', timing: '0:7' },
            { pitch: 'E5', timing: '0:8' },
            { pitch: 'D5', timing: '0:9' },
            { pitch: 'C#5', timing: '0:10' },
            { pitch: 'B5', timing: '0:11' },
            { pitch: 'A4', timing: '0:12' },
            { pitch: 'G4', timing: '0:13' },
            { pitch: 'F#4', timing: '0:14' },
            { pitch: 'E4', timing: '0:15' },
        ];
