...
const EbM_MusicPlay = ({ tempo, shouldStart, shouldRefreshPage, continuousPlay }) => {
    ...
    const handleMusicStart = async () => {
        ...
        const notes = [
            { pitch: 'Eb4', timing: '0:0' },
            { pitch: 'F4', timing: '0:1' },
            { pitch: 'G4', timing: '0:2' },
            { pitch: 'Ab4', timing: '0:3' },
            { pitch: 'Bb4', timing: '0:4' },
            { pitch: 'C5', timing: '0:5' },
            { pitch: 'D5', timing: '0:6' },
            { pitch: 'Eb5', timing: '0:7' },
            { pitch: 'F5', timing: '0:8' },
            { pitch: 'Eb5', timing: '0:9' },
            { pitch: 'D5', timing: '0:10' },
            { pitch: 'C5', timing: '0:11' },
            { pitch: 'Bb4', timing: '0:12' },
            { pitch: 'Ab4', timing: '0:13' },
            { pitch: 'G4', timing: '0:14' },
            { pitch: 'F4', timing: '0:15' },
        ];
