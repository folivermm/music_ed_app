...
import './BM_IntMusicScore.css';


const BM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        const element = document.getElementById('paper-BM-Int');
    ...
    return (
        <div>
            <div id="paper-BM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default BM_IntMusicScore;
