...
import './EbM_IntMusicScore.css';


const EbM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        abcNotation += 'E/F/G/A/ B/c/d/e/ | f/e/d/c/ B/A/G/F/ :|';

        // End on a whole note
        abcNotation += 'E4 ||';

        const element = document.getElementById('paper-EbM-Int');
    ...
    return (
        <div>
            <div id="paper-EbM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default EbM_IntMusicScore;
