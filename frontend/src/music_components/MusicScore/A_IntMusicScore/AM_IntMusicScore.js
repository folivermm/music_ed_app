...
import './AM_IntMusicScore.css';


const AM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        const element = document.getElementById('paper-AM-Int');
    ...
    return (
        <div>
            <div id="paper-AM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default AM_IntMusicScore;
