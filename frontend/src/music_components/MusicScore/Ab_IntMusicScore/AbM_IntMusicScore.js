...
import './AbM_IntMusicScore.css';


const AbM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        abcNotation += 'A,/B,/C/D/ E/F/G/A/ | B/A/G/F/ E/D/C/B,/ :|';

        // End on a whole note
        abcNotation += 'A,4 ||';

        const element = document.getElementById('paper-AbM-Int');
    ...
    return (
        <div>
            <div id="paper-AbM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default AbM_IntMusicScore;
