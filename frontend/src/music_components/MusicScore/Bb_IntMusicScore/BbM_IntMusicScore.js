...
import './BbM_IntMusicScore.css';


const BbM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        abcNotation += 'B,/C/D/E/ F/G/A/B/ | c/B/A/G/ F/E/D/C/ :|';

        // End on a whole note
        abcNotation += 'B,4 ||';

        const element = document.getElementById('paper-BbM-Int');
    ...
    return (
        <div>
            <div id="paper-BbM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default BbM_IntMusicScore;
