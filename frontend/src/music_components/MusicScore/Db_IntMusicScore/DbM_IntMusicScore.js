...
import './DbM_IntMusicScore.css';


const DbM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        abcNotation += 'D/E/F/G/ A/B/c/d/ | e/d/c/B/ A/G/F/E/ :|';

        // End on a whole note
        abcNotation += 'D4 ||';

        const element = document.getElementById('paper-DbM-Int');
    ...
    return (
        <div>
            <div id="paper-DbM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default DbM_IntMusicScore;
