...
import './GM_IntMusicScore.css';


const GM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        abcNotation += 'G/A/B/c/ d/e/f/g/ | a/g/f/e/ d/c/B/A/ :|';

        // End on a whole note
        abcNotation += 'G4 ||';

        const element = document.getElementById('paper-GM-Int');
    ...
    return (
        <div>
            <div id="paper-GM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}

export default GM_IntMusicScore;
