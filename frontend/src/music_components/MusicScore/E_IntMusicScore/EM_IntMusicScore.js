...
import './EM_IntMusicScore.css';


const EM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        const element = document.getElementById('paper-EM-Int');
    ...
    return (
        <div>
            <div id="paper-EM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default EM_IntMusicScore;
