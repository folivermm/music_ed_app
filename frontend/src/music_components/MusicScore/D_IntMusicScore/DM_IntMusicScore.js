...
import './DM_IntMusicScore.css';


const DM_IntMusicScore = ({ displayRest, tempo, shouldStart, delay }) => {
    ...
    const renderMusicScore = () => {
        ...
        const element = document.getElementById('paper-DM-Int');
    ...
    return (
        <div>
            <div id="paper-DM-Int" ref={svgRef} style={{ width: notationWidth }}></div>
        </div>
    );
}
export default DM_IntMusicScore;